@section('first-column')
    <div class="col-xl-3 col-md-4 mx-auto shfooter">
        ...
        <div class="d-md-none title" type="button" data-bs-toggle="collapse" data-bs-target="#contactInfo" aria-expanded="false" aria-controls="contactInfo">
                ...
                <li class="mt-4">
                    <ul class="navbar m-0 p-0 socials justify-content-start">
                        <li class="nav-link">
                            ...
                            target="_blank"
                            class="nav-item m-0 mb-3 me-3 p-0"
                            >
...
@section('second-column')
    <div class="col-xl-3 col-md-4 mx-auto shfooter">
        ...
        <div class="d-md-none title" type="button" data-bs-toggle="collapse" data-bs-target="#information" aria-expanded="false" aria-controls="information">
            <div class="d-flex justify-content-between align-items-center">
                <span class="align-self-center my-3 font-weight-bold fs-4">
                    <h5>Information</h5>
                </span>
...
@section('third-column')
    <div class="col-xl-3 col-md-4 mx-auto shfooter">
        ...
        <div class="d-md-none title" type="button" data-bs-toggle="collapse" data-bs-target="#myAccount" aria-expanded="false" aria-controls="myAccount">
            <div class="d-flex justify-content-between align-items-center">
                <span class="align-self-center my-3 font-weight-bold fs-4">
                    <h5>My Account</h5>
                </span>
    ...
    <div class="col-xl-3 col-md-4 mx-auto">
        ...
        <form action="/newsletter" method="post">
            ...
            <div class="input-group mb-3">
                <input type="email" class="form-control" placeholder="Enter email address" aria-label="Recipient's email" aria-describedby="newsletter">
            ...
            <div class="m-0 p-0 border-0">
                <ul class="navbar m-0 p-0">
                    <li class="nav-link m-0 me-3 p-0 footer-li">
                        <a class="text-decoration-none text-black footer-a" href="/">Home</a>
                    </li>
                    <li class="nav-link m-0 me-3 p-0 footer-li">
